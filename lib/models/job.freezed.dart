...
mixin _$Job {
 ...
 String get id; String get title; String get location; String get province; String get category; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,location,province,category,createdAt);

@override
String toString() {
  return 'Job(id: $id, title: $title, location: $location, province: $province, category: $category, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String title, String location, String province, String category, DateTime createdAt
});
...
/// Create a copy of Job
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? location = null,Object? province = null,Object? category = null,Object? createdAt = null,}) {
...
class _Job implements Job {
  const _Job({required this.id, required this.title, required this.location, required this.province, required this.category, required this.createdAt});
...
/// Create a copy of Job
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? location = null,Object? province = null,Object? category = null,Object? createdAt = null,}) {
  return _then(_Job(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,location: null == location ? _self.location : location // ignore: cast_nullable_to_non_nullable
